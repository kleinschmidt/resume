...
\cventry{2021--present}{Research Scientist}{Beacon
...
\cvcomputer{Julia}{DataFrames.jl, GLM.jl, MixedModels.jl,
  Plots.jl/Gadfly.jl}{R}{tidyverse (dplyr/purrr/tidyr),
  ggplot2, lme4/brms, rstan}

\cvcomputer{Python}{numpy, pandas, scikit-learn}{Javascript}{Node.js/express,
  frontend/JQuery}
